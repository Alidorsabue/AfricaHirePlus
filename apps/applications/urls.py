...
urlpatterns = [
    ...
    path('last-cv-info/', views.LastCvInfoView.as_view(), name='application-last-cv-info'),
    path('parse-cv/', views.ParseCvForApplicationView.as_view(), name='application-parse-cv'),
